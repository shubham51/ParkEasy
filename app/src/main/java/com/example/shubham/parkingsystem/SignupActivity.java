...
public class SignupActivity extends AppCompatActivity {
    ...
    private EditText inputEmail, inputPassword,inputName,inputaddress,inputmobile,inputvehicleno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputvehicleno=(EditText)findViewById(R.id.vehicle_no);
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String vehicleno=inputvehicleno.getText().toString().trim();
                        ...
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    User user=new User(name,Address,Mobile,new Date(0,0,0),new Date(0,0,0));
                                    mUserDatabaseReference.child("Users").child(currentUser.getUid()).setValue(user);
                                    mUserDatabaseReference.child("Vehicles").child(vehicleno).setValue(currentUser.getUid());
